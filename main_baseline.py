...
class Processor:
    ...
    def load_model(self):
        ...
        print(Model)
        self.model = Model(**self.arg.model_args, metric_func=self.arg.metric_func)
        print(self.model)
    ...
    def train(self, epoch, save_model=False):
        ...
        for batch_idx, (data, label, index) in enumerate(process):
            ...
            output = self.model(calc_diff_modality(data, **self.train_modality))
            # calculate loss and loss in the batch
