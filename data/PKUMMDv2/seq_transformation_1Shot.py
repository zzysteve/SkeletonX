...
def split_dataset(skes_joints, label, performer, evaluation, save_path, skes_name):
    if evaluation == '1Shot':
...
def get_indices(in_label, skes_name, evaluation='1Shot', num_samples_per_class=None):
    ...
    if evaluation == '1Shot' and num_samples_per_class is None:
        eval_ids = [5, 10, 13, 16, 19, 21, 26, 30, 35, 40]
        aux_ids = [i for i in range(1, 42) if i not in eval_ids]
        anchor_names = [b"A10N01-L_5", b"A02N01-L_1", b"A09N01-L_2", b"A01N01-L_3",
                       b"A04N01-L_5", b"A10N01-L_3", b"A05N01-L_1", b"A06N01-L_7",
                       b"A14N01-L_5", b"A02N01-L_2"]
...
if __name__ == '__main__':
    ...
    for evaluation in evaluations:
        split_dataset(skes_joints, label, performer, evaluation, save_path, skes_name)
